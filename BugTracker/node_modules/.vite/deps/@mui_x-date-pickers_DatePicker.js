...
} from "./chunk-QZWSKXBJ.js";
import {
  MuiPickersAdapterContext
} from "./chunk-7WFQVNTN.js";
import {
  ownerDocument
} from "./chunk-FNYXGVDJ.js";
import {
  Typography_default
} from "./chunk-JVF3263D.js";
import "./chunk-4R7GCNB2.js";
import {
  ButtonBase_default
} from "./chunk-HDHN3MFJ.js";
import {
  CSSTransition_default,
  TransitionGroup_default,
  useTimeout
} from "./chunk-XAQSBQFL.js";
import {
...
} from "./chunk-INMQVLVT.js";
import "./chunk-A7ECLLTJ.js";
import {
  refType_default,
  resolveComponentProps_default
} from "./chunk-BZYYWCOA.js";
import "./chunk-36AEHNSD.js";
import "./chunk-2RFMAK5F.js";
import "./chunk-ZPFGGG6H.js";
import {
  useControlled
} from "./chunk-5LDVWACF.js";
import "./chunk-D7KT6AOJ.js";
import {
  useForkRef
} from "./chunk-SXC6OO4G.js";
import {
  useThemeProps
} from "./chunk-DSEJVL4W.js";
import {
  alpha,
  clsx_default,
  composeClasses,
...
function useApplyDefaultValuesToDateFieldInternalProps(internalProps) {
  ...
  return React10.useMemo(() => _extends({}, internalProps, validationProps, {
...
var PickerPopperPaperWrapper = React12.forwardRef((props, ref) => {
  const {
    PaperComponent,
    ownerState,
    children,
...
function useValueAndOpenStates(parameters) {
  ...
  } = React16.useRef(defaultValueProp);
  const {
    current: isValueControlled
  } = React16.useRef(valueProp !== void 0);
  const {
  ...
  const viewValue = React16.useMemo(() => valueManager.cleanValue(utils, state.clockShallowValue === void 0 ? value : state.clockShallowValue), [utils, valueManager, state.clockShallowValue, value]);
  return {
    timezone,
    state,
    setValue,
...
var usePicker = ({
  ...
  const {
    current: initialView
  } = React17.useRef(openTo ?? null);
  const [triggerElement, triggerRef] = React17.useState(null);
  const popupRef = React17.useRef(null);
  const fieldRef = React17.useRef(null);
  const rootRefObject = React17.useRef(null);
  ...
  const ownerState = React17.useMemo(() => ({
  ...
  const triggerStatus = React17.useMemo(() => {
  ...
  const contextValue = React17.useMemo(() => _extends({}, actionsContextValue, {
    value,
    timezone,
    open: state.open,
    views,
  ...
  const privateContextValue = React17.useMemo(() => ({
    dismissViews,
    ownerState,
    hasUIView,
    getCurrentViewMode,
  ...
  const fieldPrivateContextValue = React17.useMemo(() => ({
    formatDensity,
    enableAccessibleFieldDOMStructure,
    selectedSections,
    onSelectedSectionsChange,
...
var PickersActionBar = React18.memo(PickersActionBarComponent);
...
var usePickerLayout = (props) => {
  ...
  const ownerState = React20.useMemo(() => _extends({}, pickerOwnerState, {
...
var PickersLayout = React21.forwardRef(function PickersLayout2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime8.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime8.jsxs)(React21.Fragment, {
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime9.jsxs)(React22.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime9.jsxs)(React22.Fragment, {
  children: [(0, import_jsx_runtime9.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime9.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var PickerFieldUIContext = React23.createContext({
  slots: {},
  slotProps: {},
  inputRef: void 0
});
...
function PickerFieldUI(props) {
  ...
  const pickerFieldUIContext = React23.useContext(PickerFieldUIContext);
  const {
    textFieldProps,
    onClear,
    clearable,
...
var useFieldState = (parameters) => {
  ...
  const sectionsValueBoundaries = React25.useMemo(() => getSectionsBoundaries(utils, localizedDigits, timezone), [utils, localizedDigits, timezone]);
  const getSectionsFromValue = React25.useCallback((valueToAnalyze) => fieldValueManager.getSectionsFromValue(valueToAnalyze, (date) => buildSectionsFromFormat({
    utils,
  ...
  const parsedSelectedSections = React25.useMemo(() => parseSelectedSections(selectedSections, state.sections), [selectedSections, state.sections]);
  ...
  const areAllSectionsEmpty = React25.useMemo(() => state.sections.every((section) => section.value === ""), [state.sections]);
  ...
  const sectionToUpdateOnNextInvalidDateRef = React25.useRef(null);
...
function useFieldInternalPropsWithDefaults(parameters) {
  ...
  const handleChangeFromPicker = React26.useCallback((newValue, ctx) => {
    return setValue == null ? void 0 : setValue(newValue, {
      validationError: ctx.validationError,
      shouldClose: false
    });
  }, [setValue]);
  const internalPropsWithDefaultsFromContext = React26.useMemo(() => {
...
function useFieldHiddenInputProps(parameters) {
  ...
  const valueStr = React27.useMemo(() => areAllSectionsEmpty ? "" : fieldValueManager.getV7HiddenInputValueFromSections(state.sections), [areAllSectionsEmpty, state.sections, fieldValueManager]);
  return {
    value: valueStr,
...
function useFieldSectionContainerProps(parameters) {
  ...
  const createHandleClick = React28.useCallback((sectionIndex) => (event) => {
    if (disabled || event.isDefaultPrevented()) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React28.useCallback((sectionIndex) => ({
...
function useFieldSectionContentProps(parameters) {
  ...
  const createFocusHandler = React29.useCallback((sectionIndex) => () => {
    if (disabled) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React29.useCallback((section, sectionIndex) => {
    const sectionBoundaries = sectionsValueBoundaries[section.type]({
...
var useFieldV7TextField = (parameters) => {
  ...
  const sectionListRef = React30.useRef(null);
  const handleSectionListRef = useForkRef(sectionListRefProp, sectionListRef);
  const domGetters = React30.useMemo(() => ({
  ...
  React30.useImperativeHandle(unstableFieldRef, () => ({
...
var useFieldV6TextField = (parameters) => {
  ...
  const openPickerAriaLabel = useOpenPickerButtonAriaLabel2(value);
  const sections = React31.useMemo(() => addPositionPropertiesToSections(state.sections, localizedDigits, isRtl), [state.sections, localizedDigits, isRtl]);
  ...
  const placeholder = React31.useMemo(() => {
    if (inPlaceholder !== void 0) {
      return inPlaceholder;
    }
    return fieldValueManager.getV6InputValueFromSections(getSectionsFromValue(valueManager.emptyValue), localizedDigits, isRtl);
  }, [inPlaceholder, fieldValueManager, getSectionsFromValue, valueManager.emptyValue, localizedDigits, isRtl]);
  const valueStr = React31.useMemo(() => state.tempValueStrAndroid ?? fieldValueManager.getV6InputValueFromSections(state.sections, localizedDigits, isRtl), [state.sections, fieldValueManager, state.tempValueStrAndroid, localizedDigits, isRtl]);
  React31.useEffect(() => {
  ...
  const inputMode = React31.useMemo(() => {
    if (activeSectionIndex == null) {
      return "text";
    }
...
var DateField = React34.forwardRef(function DateField2(inProps, inRef) {
  const themeProps = useThemeProps({
    props: inProps,
    name: "MuiDateField"
  });
...
var useCalendarState = (params) => {
  ...
  const utils = useUtils();
  const reducerFn = React36.useRef(createCalendarStateReducer(Boolean(reduceAnimations), utils)).current;
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React41.useMemo(() => utils.getMonth(day) !== currentMonthNumber, [utils, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
...
var MonthCalendarButton = React42.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var MonthCalendar = React43.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React43.useMemo(() => utils.getMonth(now), [utils, now]);
  const selectedMonth = React43.useMemo(() => {
    if (value != null) {
      return utils.getMonth(value);
    }
    return null;
  }, [value, utils]);
  const [focusedMonth, setFocusedMonth] = React43.useState(() => selectedMonth || utils.getMonth(referenceDate));
  ...
  const isMonthDisabled = React43.useCallback((dateToValidate) => {
...
var YearCalendarButton = React44.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var YearCalendar = React45.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React45.useMemo(() => utils.getYear(now), [utils, now]);
  const selectedYear = React45.useMemo(() => {
    if (value != null) {
      return utils.getYear(value);
    }
    return null;
  }, [value, utils]);
  const [focusedYear, setFocusedYear] = React45.useState(() => selectedYear || utils.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isYearDisabled = React45.useCallback((dateToValidate) => {
...
var PickersArrowSwitcher = React46.forwardRef(function PickersArrowSwitcher2(inProps, ref) {
  const isRtl = useRtl();
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersArrowSwitcher"
...
// node_modules/@mui/x-date-pickers/esm/DesktopDatePicker/DesktopDatePicker.js
var DesktopDatePicker = React51.forwardRef(function DesktopDatePicker2(inProps, ref) {
  var _a;
  const utils = useUtils();
...
// node_modules/@mui/x-date-pickers/esm/MobileDatePicker/MobileDatePicker.js
var MobileDatePicker = React54.forwardRef(function MobileDatePicker2(inProps, ref) {
  var _a;
  const utils = useUtils();
...
var DatePicker = React55.forwardRef(function DatePicker2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDatePicker"
  });
